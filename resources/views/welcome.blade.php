        ...
        <div class="container">
          <div class="row mb-5">
            <div class="col-12 text-center">
              <h2 class="section-title mb-3">Instagram</h2>
            </div>
          </div>
        </div>
        <div class="slide-one-item home-slider owl-carousel ">
            @for ($i = 0; $i < sizeof($instagrams); $i++)
                <div class="testimonial align-items-center justify-content-center">
                  
                  <div class="text-center col-md-12">
                    <img src="{{ $instagrams[$i]->images->standard_resolution->url }}" alt="" srcset="">
                  </div>
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-lg-6 ml-auto mb-5 order-1 order-lg-2" data-aos="fade" data-aos="fade-up" data-aos-delay="">
            <img src="images/hero_1.png" alt="Image" class="img-fluid rounded">
          </div>
